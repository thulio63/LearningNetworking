...
class Message:
    ...
    def write(self):
        ...
        if self._request_queued:
            if not self._send_buffer:
                self._set_selector_events_mask("r") # done writing, switch to reading
    ...
    def close(self):
        ...
        try:
            ...
            self.sock = None # clear ref for garbage collection
    ...
    def process_response(self):
        ...
        self.close() # close when response is processed